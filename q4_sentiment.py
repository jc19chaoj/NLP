...
### YOUR CODE HERE
REGULARIZATION = [3e-3, 2e-3, 1e-3, 1e-3, 3e-4, 2e-4, 1e-4, 1e-4, 4e-5, 3e-5, 2e-5, 1e-5, 1e-6, 1e-7]
### END YOUR CODE
...
### YOUR CODE HERE 
sorted_results = sorted(results, key=lambda k: k['dev'])
BEST_REGULARIZATION = sorted_results[-1]['reg']
BEST_WEIGHTS = sorted_results[-1]['weights']
### END YOUR CODE
